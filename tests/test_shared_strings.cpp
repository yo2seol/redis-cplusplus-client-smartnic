...
{
  redis::shared_string sh_str1(c, "sh_str1");
    
  test("not existing shared_string");
  {
  ...
  test("initialized shared_string");
  {
  ...
  test("substr on shared_string");
  {
    ...
    redis::shared_string sh_str2(c, "sh_str2", "asdf123");
